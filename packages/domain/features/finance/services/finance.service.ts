...
} from "../utils/ledgerWriteCompat.util";
import {
  AVATAR_BUCKET,
...
import { LEDGER_PAGE_SIZE, toRange, type PageOpts } from "@pulse/core/lib/pagination";
import { AUTH_TIMEOUT_MS, withTimeout } from "@pulse/core/lib/authEngine";
import { supabase } from "@pulse/core/lib/supabase";
import { notifyTripChatMessagesChanged } from "../../../lib/tripChatInvalidate";
import { VALIDATION, dateISO } from "../../../lib/validation";
import { getTripOperationalDisplay } from "../../operations/display";
import { recordTripWorkflowEvent } from "../../trips/services/tripWorkflow.service";
...
async function tryNotifyLinkedPartyChatAfterLedgerInsert(
  ...
  try {
    ...
    const { postLedgerEventToChat } = await import("../../chat/services/chatLedgerBridge.service");
