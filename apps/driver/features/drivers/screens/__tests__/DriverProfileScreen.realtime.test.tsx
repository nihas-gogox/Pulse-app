...
jest.mock('@pulse/core/contexts/LanguageContext', () => ({
...
jest.mock('../../../auth/components/EditProfileModal', () => ({
...
jest.mock('@pulse/features/features/experience/components/MilestoneHowToModal', () => ({
...
jest.mock('@pulse/domain/features/vehicles/services/vehicles.service', () => ({
...
jest.mock('@pulse/core/lib/realtimeRegistry', () => ({
