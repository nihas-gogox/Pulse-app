...
import { driverAppPathFor } from '@/features/drivers/utils/driverAppHandoff.util';
import {
...
function IndexBoot({
  ...
  useEffect(() => {
    ...
    if (profile.role === 'driver') {
      ...
      consumeFreshSignInLanding();
      if (!claimIndexBootRedirect(uid)) return;
      // Web: drivers use the Pulse Driver web app at /driver (Phase 4A, permanent since 4D).
